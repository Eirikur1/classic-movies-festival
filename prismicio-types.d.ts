...
type HomepageDocumentDataSlicesSlice = HeroSlice | FeatureListSlice
 ...
 */
export interface FeatureListSliceDefaultPrimaryItemsItem {
	/**
	 * Icon (emoji) field in *FeatureList → Default → Primary → Features*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: feature_list.default.primary.items[].icon
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	icon: prismic.KeyTextField;
	
	/**
	 * Feature title field in *FeatureList → Default → Primary → Features*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: feature_list.default.primary.items[].title
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	title: prismic.KeyTextField;
	
	/**
	 * Feature body field in *FeatureList → Default → Primary → Features*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: feature_list.default.primary.items[].body
...
export interface FeatureListSliceDefaultPrimary {
	/**
	 * Section heading field in *FeatureList → Default → Primary*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 ...
	 */
	items: prismic.GroupField<Simplify<FeatureListSliceDefaultPrimaryItemsItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type FeatureListSliceDefault = prismic.SharedSliceVariation<"default", Simplify<FeatureListSliceDefaultPrimary>, never>;
...
export interface HeroSliceDefaultPrimary {
	/**
	 * Eyebrow (small text above the title) field in *Hero → Default → Primary*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
...
declare module "@prismicio/client" {
	...
	namespace Content {
		export type {
			...
			AllDocumentTypes,
			FeatureListSlice,
			FeatureListSliceDefaultPrimaryItemsItem,
